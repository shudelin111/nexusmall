...
public class PayOrderController {
     ...
     * @return 支付单详情
     */
    @GetMapping(value = "/order/{orderNo}", headers = "X-API-Version=v1")
     ...
     * @return 处理结果
     */
    @PostMapping(value = "/callbacks/alipay", headers = "X-API-Version=v1")
     ...
     * @return 处理结果
     */
    @PostMapping(value = "/callbacks/wechat", headers = "X-API-Version=v1")
     ...
     * @return 关闭数量
     */
    @PostMapping(value = "/expired/close", headers = "X-API-Version=v1")
