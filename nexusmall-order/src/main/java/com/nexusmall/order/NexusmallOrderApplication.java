...
@ComponentScan(basePackageClasses = {NexusmallOrderApplication.class, RedisUtils.class, SeataXidFilter.class, UserBehaviorServiceImpl.class}) // 指定组件扫描范围，确保 SeataXidFilter 和 UserBehaviorService 能被扫描到
