package com.nexusmall.cart.interfaces.controller;

import com.nexusmall.cart.interfaces.dto.AddCartRequest;
import com.nexusmall.cart.application.service.CartService;
...
@Slf4j
@RestController
@RequestMapping("/cart-items")  // RESTful资源路径：购物车项集合
@ApiVersion("v1")
...
public class CartController {
     ...
     * 清空购物车
     */
    @DeleteMapping(value = "/", headers = "X-API-Version=v1")
     ...
     * 全选/全不选
     */
    @PatchMapping(value = "/select-all", headers = "X-API-Version=v1")
    @Operation(
        summary = "全选/全不选",
