...
public class ProductServiceImpl implements ProductService {
    ...
    public boolean decreaseStock(Long skuId, Integer count) {
        ...
        if (result > 0) {
            ...
            throw new ProductException(CommonResultCode.INSUFFICIENT_STOCK.getErrorCode(), CommonResultCode.INSUFFICIENT_STOCK.getMessage());
        }
    }
    ...
    public boolean increaseStock(Long skuId, Integer count) {
        ...
        if (result > 0) {
            ...
            throw new ProductException(CommonResultCode.STOCK_OPERATION_FAILED.getErrorCode(), CommonResultCode.STOCK_OPERATION_FAILED.getMessage());
        }
    }
